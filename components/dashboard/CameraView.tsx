...
const CameraView: React.FC<CameraViewProps> = ({ videoRef, postureStatus, onToggleCamera, isCameraEnabled, poseLandmarks }) => {
    ...
    <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 h-full flex flex-col">
      ...
      <div className="flex items-center justify-between mt-auto">
        ...
        <button
          ...
          className={`px-5 py-2 rounded-full font-bold text-white text-xs transition-all shadow-md hover:shadow-lg active:scale-95 ${isCameraEnabled ? 'bg-red-500 hover:bg-red-600 shadow-red-500/20' : 'bg-black dark:bg-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-100'
            }`}
        >
